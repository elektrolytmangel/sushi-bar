class ProgressBar extends HTMLElement {
  ...
  constructor() {
    ...
    this.shadow.innerHTML = '<link rel="stylesheet" href="./assets/css/progressbar.css">';
    ...
    this.progressValue = parseInt(this.getAttribute('progress') || '');
  ...
  connectedCallback(): void {
    setTimeout(() => this.progress.setAttribute('style', `width: ${this.progressValue}%`), 1);
  }
}
